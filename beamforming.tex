...
Ces méthodes sont très utilisées \todo{référence} car elles offrent beaucoup de flexibilité sur la position des capteurs et sont simplew à mettre en œuvre. Cependant, elles offrent une résolution fortement dépendante de la géométrie de l'antenne.\\
...
\subsection{Vecteur de pointage indépendant des données}
