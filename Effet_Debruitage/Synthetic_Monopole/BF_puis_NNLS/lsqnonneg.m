...
disp('Warning : Fonction lsqnonneg Matlab modifiée par Alice')
...
outeriter = 0;
outeritermax=optimget(options,'MaxIter',Inf);
iter = 0;
itmax = 3*n;
exitflag = 1;

% Outer loop to put variables into set to hold positive coefficients
while any(Z) && any(w(Z) > tol) && outeriter<outeritermax
