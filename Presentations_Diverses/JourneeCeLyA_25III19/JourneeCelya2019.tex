...
\onslide<12->{
	...
	\includegraphics[valign=m,width=0.18\textwidth]{csm.png} &= & \includegraphics[valign=m,width=0.18\textwidth]{signal.png} & +&  \includegraphics[valign=m,width=0.18\textwidth]{bruit.png}\\
	\end{tabular}
}
\end{frame}
...
\parbox{3cm}{
\begin{align*}
	    \bm{S}_{aa} &= \bm{S}_{pr}\bm{S}_{rr}^{-1}\bm{S}_{rp}\\
	    &= \bm{\gamma}^2_{pr} \circ \bm{S}_{pp}
\end{align*}
}}
\end{center}

$ \bm{\gamma}^2_{pr}$ : Cohérence multiple\\
\vfill
\pause
...
\parbox{\textwidth}{
	\begin{figure}
		\centering
		\subfloat[\scriptsize  Raw (high engine speed).]{\includegraphics[trim = 2ex 1ex 0 0,clip, width=0.32\textwidth]{./airbus/as_raw.png}}
		\subfloat[\scriptsize  Background noise (idle engine speed).]{\includegraphics[trim = 2ex 1ex 0 0,clip,width=0.32\textwidth]{./airbus/as_bg.png}} 
		\subfloat[\scriptsize   Background subtraction.]{\includegraphics[trim = 1.3ex 1ex 0 0,clip,width=0.385\textwidth]{./airbus/as_bgsub.png}}\\
		\subfloat[\scriptsize   PFA denoising.]{\includegraphics[trim = 2ex 1ex 0 0,clip,width=0.32\textwidth]{./airbus/as_pfa.png}}
		\subfloat[\scriptsize   Referenced denoising.]{\includegraphics[trim = 2ex 1ex 0 0,clip,width=0.32\textwidth]{./airbus/as_ref.png}}\\
	\end{figure}
	}
%		}
\end{frame}
