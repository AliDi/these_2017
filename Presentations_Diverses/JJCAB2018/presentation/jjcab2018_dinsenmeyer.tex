...
\begin{minipage}{0.75\textwidth}
	...
	\end{itemize}
\end{minipage}\\[1em]
\onslide<2->{\tikz[baseline]{\draw[->,>=latex, line width=1.05pt] (0,1.3em) -- ++(0,-1.1em) -- ++(1.5em,0);} {\bfseries Faire une décomposition matricielle : \\
MI mesurée = MI signal + MI bruit}\\[1em]}
