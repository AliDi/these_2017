...
\begin{minipage}[t]{0.24\textwidth}
	...
	{ \bfseries Choisir des distributions \textit{a priori}}\\[1.5em]
...
\begin{minipage}[t][1cm][t]{\textwidth}
	\centering
	\node[inner sep=0pt,overlay,anchor=north west] () at (-1.1cm,1.5cm)  {\includegraphics[width=0.31\paperwidth]{contexte.png} };
\end{minipage}
 }
