...
%mise à zéro ou soustraction : pourquoi ?\\
 ...
 \noindent \bfseries Séparer la contribution des sources acoustique du bruit de couche limite turbulente.\\
 }
...
\begin{minipage}{\textwidth-3.1cm}
 ...
 - signal corrélé, peu de monopoles équivalents décorrélés : \textbf{MI à rang réduit}.\\[-2ex]
\end{minipage}
 ...
 \centering  Faire une décomposition matricielle par de l'optimisation bayésienne :\\[1.5em]
...
\begin{minipage}[t]{0.23\textwidth}
	...
	{ \bfseries Choix des distributions \textit{a priori}}\\[1.5em]
...
\begin{minipage}[t][1cm][t]{\textwidth}
	\centering
	\node[inner sep=0pt,overlay,anchor=north west] () at (-1cm,1.5cm)  {\includegraphics[width=0.31\paperwidth]{contexte.png} };
\end{minipage}
 }
  
 \headerbox{L'échantillonneur de Gibbs}{name=gibbs,below=methode,column=0,span=3}{
 \noindent $\bullet$ Approxime la distribution jointe inconnue  $p(\theta_1,\theta_2,\dots|\bm{S}_{pp})$ \\à partir des distributions conditionnelles connues $p(\theta_1|\bm{S}_{pp},\theta_2,\dots)$\\
...
~\\~\\~\\
\centering
\noindent \includegraphics[width=0.9\textwidth]{imagerie_final.eps} 
...
~\centerline{\resizebox{0.5cm}{!}{\circled{\textbf{+}}}} \\[1ex]
 ...
 - fournit des intervalles de crédibilité}\\~\\
  ...
  - la MI conserve un sens physiques\\
...
$\bullet$ Adapter le modèle à un bruit corrélé sur les microphones.\\[-0.9ex]
 }
