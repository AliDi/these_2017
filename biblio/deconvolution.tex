...
On veut que G soit tel qu'il contienne toutes les contributions des sources corrélées avec pmax. Ainsi, la projection de G sur wmax est égale à la projection des données (Spp) sur wmax : \\
Gwmax = Dwmax.\\
