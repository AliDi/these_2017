...
\end{figure}
!!! à chaque fois, sur les données Spp et Sppclean mettre la diagonale à 0 !!!
+critère d'arrêt si sum(sum(Spp)) se met à augmenter

CLEAN possède des extensions telles que CLEAN-PSF ou CLEAN-SC. Ces extensions sont très utilisées pour la localisation de sources aéroacoustiques.
\todo[inline,color=green!10]{algo Hogbom en python : \url{http://www.mrao.cam.ac.uk/~bn204/alma/python-clean.html}}
