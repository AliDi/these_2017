...
\subsection{Classical Printcipal Component Analysis (PCA)}
...
Ce problème peut être résolut par les algorithmes classiques d'optimisation convexe .
...
Ce problème peut assi être résolu 
