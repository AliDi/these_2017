...
\cite{Bahr2015} se basent sur une décomposition en VP de la CSM du bruit. Une seconde décomposition en VP permet de garantir un maintient de la CSM positive. Analogue à une PCA.
