\subsection{Ajout d'une étape de déconvolution}
...
Cette méthode est une heuristique (algorithme d'approximation) de type "matching pursuit".\todo{détailler "Matching pursuit"}\\
