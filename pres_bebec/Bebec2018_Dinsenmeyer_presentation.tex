...
\begin{frame}[t]{Problem Statement}
	...
	\begin{itemize}	
		\item Rank of $\textcolor{green}{\bm{S}_{aa}}=$ number of equivalent uncorrelated monopoles
	\end{itemize}
	}
\end{frame}
...
\begin{frame}{\insertsectionhead~--~CSM properties}
	...
	\begin{itemize}
		...
		\item Short correlation length : off-diagonal elements of $\textcolor{red}{S_{nn}}\rightarrow 0$\\[1em]
		\pause
