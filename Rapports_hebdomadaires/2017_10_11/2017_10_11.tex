\documentclass[twocolumn, 11pt, landscape]{article}
...
\begin{figure}[!h]
	\begin{subfigure}[b]{0.22\textwidth}
		\includegraphics[width = 1.2\textwidth]{/home/adinsenmey/Bureau/these_2017/Rapports_hebdomadaires/2017_10_11/img/BF_averaged.png}
		\caption{Fonction de Green : monopole}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.22\textwidth}
		\includegraphics[width = 1.2\textwidth]{/home/adinsenmey/Bureau/these_2017/Rapports_hebdomadaires/2017_10_11/img/BF_GreenFlow_averaged.png}
...
\begin{figure}[!h]
	...
	\begin{minipage}{0.45\textwidth}	
		\begin{algorithmic}
			\STATE cvx\_begin
			\STATE variable d(M)
			\STATE  CSM + diag(d) == hermitian_semidefinite(num_mic)
