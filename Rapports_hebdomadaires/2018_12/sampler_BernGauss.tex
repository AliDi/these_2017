...
\subsection[]{Pour le couple $\beta^2, \bm{\sigma}$}
L'ambiguité se pose également pour le couple $\beta^2, \bm{\sigma}$ dans le cas où on exploite P jeux de données (pour différents régime moteur par ex.).
