function [Sq Sy Sp Sn] = generate_Spp_signal(freqs , Nsrc , rho , SNR, Mw)
...
% 
% figure
% plot3(r_mic(:,1),r_mic(:,2),r_mic(:,3),'ok','markersize',4)
% hold on
% plot3(x_src(:),y_src(:),z_src(:),'dk','Markerfacecolor','k','markersize',4)
% %title('Configuration')
