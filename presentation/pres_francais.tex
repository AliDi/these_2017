...
\begin{frame}
	...
	108 chercheurs permanents + 80 doctorants\\
	axes de recherche : géochimie, géophysique, risques
	
	Consortium industriel Seiscope : imagerie géophysique, prospection pétrolière
	
	\begin{tikzpicture}[remember picture,overlay,shift={(\textwidth-1cm,-0.5\textheight+3cm)}]
		\node[]{\includegraphics[width=2cm]{img/logo_isterre.jpg}};
	\end{tikzpicture}
